...
import com.gustavo.pacchetto_sicurezza.exception.MyAPIException;
...
import com.gustavo.pacchetto_sicurezza.security.JwtTokenProvider;
...
public class AuthServiceImpl implements AuthService {
    ...
    public ERole getRole(String role) {
    	...
    	else if(role.equalsIgnoreCase("PRIME")) return ERole.ROLE_USER_PRIME;
